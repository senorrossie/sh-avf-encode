...
int main(int argc, char **argv) {
	...
	for(;;) {
		...
		for(int y=0; y<32; ++y) {
			putc(abuf[y], fo);
			putc(abuf[y + 0*32 + 70], fo);
			putc(abuf[y + 1*32 + 70], fo);
			putc(abuf[y + 2*32 + 70], fo);
			putc(abuf[y + 3*32 + 70], fo);
			putc(abuf[y + 4*32 + 70], fo);
			putc(abuf[y + 5*32 + 70], fo);
